...
const Menu = () => {
    ...
    const { user, logout } = authContext!; // Obtén el usuario y la función de logout
    ...
    return (
        <header className={`Heading ${theme}`}>
            ...
            <nav className={`Heading-nav ${isNavVisible ? 'visible' : 'hidden'}`}>
                <ul className="Heading-ul">
                    <li className="Heading-li">
                        <NavLink to='/Home' className={"nav-link active"}>Home</NavLink>
                    </li>|
                    <li className="Heading-li">
                        <NavLink to='/ResponsiveComponents' className={"nav-link active"}>Componentes</NavLink>
                    </li>|
                    <li className="Heading-li">
                        <NavLink to='/SeriesReducer' className={"nav-link active"}>C-drama</NavLink>
                    </li>|
                    <li className="Heading-li">
                        <NavLink to='/CatsApp' className={"nav-link active"}>Gatos</NavLink>
                    </li>|
                    <li className="Heading-li">
            ...
            <button className="Heading-button" onClick={toggleTheme}>
                {theme === 'light' ?
            ...
            {user ? (
                <div>
                    ...
                    {/* Icono para cuando a iniciado sesión el usuario */}
                    <button
                    ...
                    <button className='Heading-button' onClick={logout}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
            ...
            {/* Botón para mostrar/ocultar el menú, visible solo en pantallas pequeñas */}
            <button onClick={toggleNav} className="Heading-toggle">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M2 2h12v2H2V2zm0 6h12v2H2V8zm0 6h12v2H2v-2z" />
                </svg>
            </button>
